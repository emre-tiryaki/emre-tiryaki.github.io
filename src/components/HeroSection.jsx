      ...
      <div className="grid items-center gap-14 lg:grid-cols-[1.15fr_0.85fr]">
        <div>
          ...
          <p className="mt-3 text-xl text-slate-200 md:text-2xl light:text-slate-700">
            Fullstack Developer <span className="px-2 text-sky-400">|</span> Data Scientist <span className="px-2 text-sky-400">|</span> ML Engineer
          </p>
          <p className="mt-8 max-w-2xl text-sm leading-7 text-slate-400 light:text-slate-600">
            Architecting robust digital solutions with a focus on clean code, SOLID principles, and seamless DevOps integration. Bridging the gap between complex data and intuitive applications.
          </p>
          <div className="mt-10 flex flex-wrap items-center gap-4">
            <a href="#projects" className="rounded-lg bg-sky-500 px-6 py-3 text-sm font-bold text-white transition hover:bg-sky-400">View Projects</a>
            <a href="#contact" className="rounded-lg border border-white/20 bg-white/5 px-6 py-3 text-sm font-bold text-white transition hover:border-white/40 light:border-slate-400 light:bg-white light:text-slate-900">Contact Me</a>
          </div>
        </div>
              ...
              >
                <img
                  ...
                  className={`aspect-square w-full object-cover transition-transform duration-700 ease-[cubic-bezier(0.22,0.61,0.36,1)] ${
                    slot === 'center' ? 'scale-100' : 'scale-105'
                  }`}
                />
              </article>
              )
