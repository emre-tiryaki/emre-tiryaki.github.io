...
export default function InternshipCard({ company, title, location, startDate, endDate }) {
  ...
  return (
    <div className="glass-card p-5 border-l-4 border-l-orange-500 hover:border-r hover:border-r-orange-500/30 transition-all duration-300">
      <div className="flex items-start justify-between gap-4">
        <div>
          <span className="inline-block px-2.5 py-0.5 text-xs font-semibold rounded-md bg-orange-500/10 text-orange-400 border border-orange-500/20 mb-2">
