import { FiZap, FiCalendar, FiMapPin } from 'react-icons/fi';
...
export default function HackathonCard({ company, title, location, date, duration }) {
  ...
  return (
    <div className="glass-card rounded-xl border-l-4 border-l-emerald-500 border border-white/10 hover:border-emerald-500/30 transition-all duration-300"
      ...
      <span className="inline-flex items-center gap-1 px-2 py-0.5 text-[10px] font-mono font-bold rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 mb-1.5 uppercase tracking-wider">
        <FiZap size={10} />
