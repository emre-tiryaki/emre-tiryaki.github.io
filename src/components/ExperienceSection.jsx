      ...
      <div className="relative mx-auto mt-12 max-w-2xl border-l border-sky-500/40 pl-8 before:absolute before:-left-[5px] before:top-0 before:h-2 before:w-2 before:rounded-full before:bg-sky-500 md:border-none md:pl-0">
        <div className="grid gap-8">
          <article className="glass-card p-6">
            <p className="text-xs font-bold uppercase tracking-[0.14em] text-sky-400">2023</p>
            ...
            <p className="mt-4 text-sm leading-7 text-slate-400 light:text-slate-600">Collaborated in a high-intensity environment to develop a news-verification tool utilizing NLP and big data analysis.</p>
          </article>
        </div>
      </div>
    </section>
